...
# also include the volatility for completeness:
actual_parameters = rbind(actual_parameters[1,],
                          diag(covariance),
                          actual_parameters[2:4,])

rownames(actual_parameters)= c("mu", "sigma","theta", "delta", "lambda")
