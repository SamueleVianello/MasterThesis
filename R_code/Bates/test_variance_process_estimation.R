...
roll_sd = rolling_stdev(rev(asset)[1:dn],window=5,skip = 1)
...
roll_sd = rolling_stdev(rev(asset)[1:dn],window=5,skip = 5)
...
roll_sd = rolling_stdev(rev(asset)[1:dn],window=21,skip = 21)
